...
namespace SchoolBuddy.Models
{
    ...
    public class SettingsNotifyPropertyChanged<T> : INotifyPropertyChanged
    {
        ...
        public T Value
        {
            get
            {
                object val = Settings.GetSetting(_name);
                if (val == null)
                {
                    return default;
                }
    ...
    public class SettingsNotifyPropertyChanged<TFriendlyValue, TStoreValue> : INotifyPropertyChanged
    {
        ...
        public TStoreValue StoreValue
        {
            get
            {
                object v = Settings.GetSetting(_settingsName, _defaultValue);
                if (v == null)
                {
                    return default;
                }

                TStoreValue proc = _storeCalculate(v.ToString());
                return proc;
            }
            set
            {
                string a = _storeCompute(value);

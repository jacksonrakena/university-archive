...
public class TrainService{
    ...
    public Integer getTimeForStation(Station station) {
        return getTrainLine().getStations().contains(station) ? getTimes().get(getTrainLine().getStations().indexOf(station)) : -1;
    }

...
public class Move implements Operation {
	...
	public static boolean nextTo(Location l1, Location l2) {
		// use the hypotenuse function (which returns the distance between two points)
		// distance between them should be 1 if they're next to each other, ~1.5 if they're diagonal
		return Math.hypot(l1.row-l2.row, l1.col-l2.col) == 1;
	}
}

...
public class DTNode{
    ...
    private String text;
    private Map<String, DTNode> children;
     ...
     */
    public DTNode(String txt, HashMap.SimpleEntry<String, DTNode>... children){
        text = txt;
        this.children = Arrays.asList(children).stream().collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    }
    ...
    public Map<String, DTNode> getChildren() { return this.children; }

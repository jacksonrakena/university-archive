...
int main()
{
    ...
    {
        write_waveform_samples(sample_length, sample_rate * duration_of_each_tone_in_repeat, ambulance_high, 6000, waveform, write_head);
        write_head += duration_of_each_tone_in_repeat * (float)sample_rate;
        write_waveform_samples(sample_length, sample_rate * duration_of_each_tone_in_repeat, ambulance_low, 6000, waveform, write_head);
        write_head += duration_of_each_tone_in_repeat * (float)sample_rate;
    }

...
int main(void)
{
    ...
    printf("----------------------\n");
    strcpy(editing_buffer, "The quick br");
    printf("Initial  buffer contents: %s\n", editing_buffer);
    printf("Call: editor_replace_str(editing_buffer, 0, \"brown\", \"blue\", 30);\n");
    ret = editor_replace_str(editing_buffer, 0, "brown", "blue", strlen(editing_buffer));
    strcpy(expected_buffer, "The quick br");
    printf("Expected buffer contents: %s\n", expected_buffer);
    printf("Actual   buffer contents: %s\n", editing_buffer);
    printf("Expected return value: -1\n");
    printf("Actual   return value: %d\n", ret);

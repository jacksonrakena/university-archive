...
public class Patient implements Comparable<Patient>{
    ...
    public List<String> getAllTreatments() { return this.treatments; }
    ...
    public int compareTo(Patient other){
        return this.priority-other.priority == 0 ? this.arrival-other.arrival : this.priority-other.priority;
    }
